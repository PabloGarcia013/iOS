...
class Coches: UITableViewController {
    ...
    func poblarCoches(){
        ...
        let coche6 : ModelCoches = ModelCoches(name: "Toyota",color: "Negro")
        ...
        let coche12 : ModelCoches = ModelCoches(name: "Hammer",color: "Negro")
